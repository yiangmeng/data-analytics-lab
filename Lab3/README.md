...
>[https://s3-ap-southeast-1.amazonaws.com/aws-slides-pdf/msd/redshiftspectrumglue-lab3.template.json](https://s3-ap-southeast-1.amazonaws.com/aws-slides-pdf/msd/redshiftspectrumglue-lab3.template.json)

6. Click **Next**

>**Note:**
>Click on the link [redshiftspectrumglue-lab3.template.json](../Lab3/redshiftspectrumglue-lab3.template.json) to view the Amazon CloudFormation template file
...
## Summary
In this lab, you've used Glue to quickly crawl both CSV and Parquet datasets into a centralised Data Catalogue, and used a Redshift Cluster's Spectrum feature to quickly get insights from it.
