# Lab 3: Serverless Analysis of data in Amazon S3 using Amazon Athena
...
![architecture-overview-lab1.png](images/architectural-diagram.png)
...
![athenacatalog.png](images/athena-query.png)
...
1. Ensure that current AWS region is **Singapore (ap-southeast-1)** region
...
![athenatablecreatequery-yellowtaxi.png](images/athena-query2.png)
...
![athenaselectquery-yellowtaxi.png](images/athena-query3.png)
...
````
Results for the above query look like the following:
![athenacountquery-yelllowtaxi.png](images/athena-total-count.png)
...
````
Results for the above query look like the following:
![athenacasequery-yelllowtaxi.png](images/avg-amount.png)
...
![athenatablecreatequery-nytaxi.png](images/query-mydatabase.png)
...
![athenacountquery-nytaxi.png](images/count-total-count.png)
...
Results for the above query look like the following:
![athenagroupbyyearquery-nytaxi.png](images/year-total-count.png)
...
![athenacountbyyearquery-nytaxi.png](images/year-month-total-count.png)
...
![athenagroupbymonthtypequery-nytaxi.png](images/month-type-total-count.png)
